...
public interface Q02_YasHesaplatma {
    // Doğumtarihini alıp yaşını hesaplatma
    ...
    public static void main(String[] args) {
     ...
     //  String stringdate = scan.nextLine();
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("Tr"); // Tarihsel Kodlarda birkez format pelirlemek gerekiyor.
